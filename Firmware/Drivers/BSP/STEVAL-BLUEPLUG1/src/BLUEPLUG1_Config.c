...
#if USER_DEFINED_PLATFORM == STEVAL_BLUEPLUG1

/**
 * @brief BlueNRG1 Eval Board (STEVAL-IDB007V1) Buttons definitions
 */
#ifdef STEVAL_BLUEMIC1
 const uint32_t s_vectnButtonPinVersion[SDK_PLATFORMS_NUMBER][EVAL_BOARD_BUTTONS] = {{GPIO_Pin_1}};
#else 
 const uint32_t s_vectnButtonPinVersion[SDK_PLATFORMS_NUMBER][EVAL_BOARD_BUTTONS] = {{GPIO_Pin_12}};
#endif
 ...
 */
#ifdef STEVAL_BLUEMIC1
 const uint32_t s_vectnGpioPinVersion[SDK_PLATFORMS_NUMBER][EVAL_BOARD_LEDS] = {{GPIO_Pin_2, GPIO_Pin_3,}};  // 2 IS BLUE, 3 IS GREEN
#else
 const uint32_t s_vectnGpioPinVersion[SDK_PLATFORMS_NUMBER][EVAL_BOARD_LEDS] = {{GPIO_Pin_3, GPIO_Pin_14}};
#endif
...
#endif
#elif USER_DEFINED_PLATFORM == STEVAL_BLUEPLUG1
    s_SdkEvalVersion = ID_STEVAL_BLUEPLUG1;
#endif
