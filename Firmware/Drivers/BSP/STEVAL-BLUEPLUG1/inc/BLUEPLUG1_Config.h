...
#define STEVAL_BLUEPLUG1 3

#ifndef USER_DEFINED_PLATFORM
#ifdef SMART_PLUG
#define USER_DEFINED_PLATFORM STEVAL_BLUEPLUG1
#else
...
#include "USER_Platform_Configuration_STEVAL_BLUEPLUG1.h"
#else 
...
#include "BLUEPLUG1_Button.h"
#include "BLUEPLUG1_Com.h"
//#include "BLUEPLUG1_I2C.h"
#include "BLUEPLUG1_Led.h"
//#include "BLUEPLUG1_SPI.h"
...
#ifdef BLUENRG_TILE
  ID_STEVAL_BCN002V1,   /* BlueNRG-2 Development platform: STEVAL-BCN002V1 */
#endif
  ID_STEVAL_BLUEPLUG1
};
