...
#ifdef BLUENRG_TILE
/**
 * @brief BlueNRG1 Eval Board (STEVAL-BCN002V1) Buttons definitions
 */
 ...
 */
#define SDK_EVAL_LED1_PIN             GPIO_Pin_14 //LED Yellow
#define SDK_EVAL_LED2_PIN             GPIO_Pin_3  //LED Red
