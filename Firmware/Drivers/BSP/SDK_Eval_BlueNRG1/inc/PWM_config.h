...
#define PWM0_PIN			            GPIO_Pin_4 
/* GPIOs pins (SOFTWARE PWM) used to output a PWM signal */
#define PWM1_PIN		        GPIO_Pin_3 //R
#define PWM2_PIN                        GPIO_Pin_1   
#define PWM3_PIN                        GPIO_Pin_14 //G
#define PWM4_PIN                        GPIO_Pin_0 //B
#endif
/**************************************************************************/
