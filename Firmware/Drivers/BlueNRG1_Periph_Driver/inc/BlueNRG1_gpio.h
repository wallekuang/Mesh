...
void GPIO_WriteBitLowPowerModes(uint32_t GPIO_Pins, BitAction BitVal);   /* Set the output state of the GIO9, GIO10, GIO11 during low power modes. BlueNRG-2 only */
