...
/**
 * @brief BLE Mesh configuration, no Controller Privacy, no LE Secure Connections, no Data Length Extension
 */
#define BLE_STACK_MESH_CONFIGURATION  (3U)
...
*/
#define BLE_STACK_CONFIGURATION        BLE_STACK_MESH_CONFIGURATION 
#endif 
...
/**
 * @brief Mesh BLE stack configuration
 */
#elif (BLE_STACK_CONFIGURATION == BLE_STACK_MESH_CONFIGURATION) 
